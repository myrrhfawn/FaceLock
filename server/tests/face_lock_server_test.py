...
from app.client import FaceLockClient, RegisterUserMessage, SERVER_HOST, SERVER_PORT
...
class TestFaceLockServer(unittest.TestCase):
    ...
    def test_register_user(self):
        ...
        message = RegisterUserMessage(username="Joe Biden", password="12345", encode_data=biden_encoding)
